...
digraph process {
    ...
    "Use orbit-finishing" [shape=box style=filled fillcolor=lightgreen];
    ...
    "Dispatch final code reviewer subagent (../requesting-code-review/code-reviewer.md)" -> "Use orbit-finishing";
}
```
...
- Final whole-branch review: use orbit-review's [code-reviewer.md](../requesting-code-review/code-reviewer.md)
...
- **orbit-review** - Code review template for the final whole-branch review
...
- **orbit-executing** - Use for parallel session instead of same-session execution
